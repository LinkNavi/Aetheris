...
inline constexpr std::array<ItemDef, ITEM_COUNT> ITEM_DEFS = {{
    ...
    {"Thornvel Ore", "Very high durability. Extended bleed.", ItemType::Ore,
     64},
    ...
    {"Sovereign Shard", "From the ruins of Aldric's campaign.",
     ItemType::Material, 4},
    ...
    {"Counter Totem", "Extends counter window after parry.", ItemType::Totem,
     1},
    {"Ironwall Totem", "Active: shield bash staggers enemy.", ItemType::Totem,
     1},
    ...
    {"Soulbond Totem", "Companion survives lethal hit once.", ItemType::Totem,
     1},
    ...
    {"Hunter Totem", "Weak point shown after enemy attack.", ItemType::Totem,
     1},
    ...
    {"Barrier Totem", "Active: place damage-absorbing field.", ItemType::Totem,
     1},
    {"Warding Totem", "Enemies slowed after hitting your ward.",
     ItemType::Totem, 1},
    ...
    {"Toxin Totem", "Poison applies faster and lasts longer.", ItemType::Totem,
     1},
