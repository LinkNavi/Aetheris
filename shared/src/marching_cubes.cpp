...
// ── Lookup tables ─────────────────────────────────────────────────────────────
// Standard Marching Cubes edge and triangle tables (Paul Bourke)
...
static const int triTable[256][16] = {
    ...
    {2,5,10,2,3,5,3,7,5,-1},{8,2,0,8,5,2,8,7,5,10,2,5,-1},{9,0,1,2,3,5,2,5,10,5,3,7,-1},{9,8,2,9,2,1,8,7,2,10,2,5,7,5,2,-1},
...
// ── Corner offsets ────────────────────────────────────────────────────────────
static const glm::ivec3 corners[8] = {
...
static glm::vec3 interp(float iso,
                        glm::vec3 p0, float v0,
...
ChunkMesh marchChunk(const ChunkData& chunk) {
    ...
    for (int x = 0; x < N-1; x++) {
        ...
        for (int t = 0; triTable[cubeIndex][t] != -1; t += 3) {
            glm::vec3 v0 = edgeVerts[triTable[cubeIndex][t  ]];
