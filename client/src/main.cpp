...
int main(int argc, char **argv) {
  ...
  // ── ImGui init ────────────────────────────────────────────────────────
  {
    ...
    imInfo.DescriptorPool = ctx.dsPool; // reuse or make a dedicated one
